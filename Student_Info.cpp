...
int main(){
        ...
        switch(ch){
            case '1': system("cls"); system("color 4e");
                ...
                enterData(data,n);
                break;
            case '2': system("cls"); system("color 5e");
                displayData(data,n);
                break;
		 	case '3': system("cls"); system("color 2e");
                bubbleSort(data,n);
                displayData(data,n);
                break;
		 	case '5': system("cls"); system("color 6e");
                selectionSort(data,n);
                displayData(data,n);
                break;
            case '4': system("cls"); system("color 4e");
                insertionSort(data,n);
                displayData(data,n);
                break;
		 	case '6': system("cls"); system("color 4b");
                linearSearch(data,n);
                break;
		 	case '7': system("cls"); system("color 2e");
                binarySearch(data,n);
                break;
		 	case '8':system("cls"); system("color 5e");
                Deletion(data,n);
                break;
		 	case '9': system("cls"); system("color 5e");
                cout<<"\n*****************************************************************************************"<<endl;
            	...
            	cout<<"*****************************************************************************************"<<endl;
            	break;
		 	case '0':system("cls"); system("color 3f");
                cout<<"\n************************************************************";
		 	    cout<<"\n**********Thanks For Watching***********";
                cout<<"\n***********Exit successfully************\n\n";
                cout<<"\a\a\a\a\a\a\a";
